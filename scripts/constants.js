	...
	'Zhao Yun': [
		{
			...
			'Requirement': "First lead Xiahou Dun into the fire attack spot, then defeat Xiahou Dun. Next lead Han Hao into the ambush location, then defeat him after Guan Ping appears. Next lead Yu Jin into the next ambush spot, then defeat him after Guan Yu appears. After Zhang Fei appears in the castle and burns the supply depot, lead Zhuge Liang into the castle to meet Cao Cao."
		}, {
			'Game': "DW4",
			'Name': "Raging Dragon",
			'Rank': 5,
